...
UPDATE animal
SET speed = 0, defense = 0, loyalty = 0, owner = 0
WHERE type = 'hond';
...
-- Verwijder de 2 honden uit de tabel animal. Met welke query kun je dit doen?
DELETE FROM animal
WHERE type = 'hond';

-- Controleer ook of beide honden zijn verwijderd.
SELECT * FROM animal
WHERE type = 'hond';
